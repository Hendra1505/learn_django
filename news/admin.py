...
class CategoryAdmin(admin.ModelAdmin):
    # Menampilkan kolom "name" dan "created_at" di halaman admin
...
# Membuat Custom Form untuk User Add User
...
class NewsAdmin(admin.ModelAdmin):
    # Menampilkan kolom "title", "status", "user" dan "created_at" di halaman News list di Admin
    ...
    search_fields = ['title']
    # Menambahkan fitur filter berdasarkan kolom "status"
    list_filter = ('status', )
